						...
						<tbody>
							<c:forEach items="${ User }" var="user">
								<tr>
									...
									<td><a href="<%=request.getContextPath() %>/user/edit?id=${user.id}" class="btn btn-sm btn-primary">Sửa</a> <a
										href="<%= request.getContextPath() %>/user/delete?id=${user.id}" class="btn btn-sm btn-danger">Xóa</a> <a
