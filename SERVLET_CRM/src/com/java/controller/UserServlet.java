...
@WebServlet(urlPatterns = { UrlConstants.USER_URL, "/user/add", "/user/details", "/user/edit","/user/delete" })
public class UserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case UrlConstants.USER_URL:
			List<UserDTO> listUser = userDao.findAll();
		...
		case "/user/edit":
			...
			User user_edit = userDao.findById(id_edit);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		User user = new User(id, email, password, fullName, avatar, role_id);
